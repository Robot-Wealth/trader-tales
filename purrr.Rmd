...
## Functionals: what and why


- problem solving centred on functions - a good fit for data analysis
- functions behave like other data structures, eg you can assign them to a variable, create them inside other functions, return them as a results of a function etc

Functionals allow you to take a function that solves the problem for a single input and generalise it to handle any number of inputs. 
...
While you're learning purrr, there's one approach to replacing for loops with functionals that fits really nicely with the purrr syntax.
Example. We'll see this below. 
...
### Understanding purrr's .x notation ###
