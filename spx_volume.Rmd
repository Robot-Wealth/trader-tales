...
Possible solutions:
- try gc() - why does this work?
- preallocate vector of size - might work if other stuff fragments available memory
- make more memory available to R by shutting other stuff down - but how big are R objects?
- split data into managable chunks
- parallelize chunks (but speed isn't the bottleneck)
- spark
- profvis
